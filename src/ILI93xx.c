...
{ 	 
	...
	GPIO_InitStructure.GPIO_OType = GPIO_OType_PP;
	GPIO_InitStructure.GPIO_Pin = 0b1100011100110011;
	...
	//PB15 推挽输出,控制背光
	//GPIO_Set(GPIOD,(3<<0)|(3<<4)|(7<<8)|(3<<14),GPIO_MODE_AF,GPIO_OTYPE_PP,GPIO_SPEED_100M,GPIO_PUPD_PU);
	//PD0,1,4,5,8,9,10,14,15 AF OUT
	//GPIO_Set(GPIOE,(0X1FF<<7),GPIO_MODE_AF,GPIO_OTYPE_PP,GPIO_SPEED_100M,GPIO_PUPD_PU);
	//PE7~15,AF OUT
	//GPIO_Set(GPIOF,PIN12,GPIO_MODE_AF,GPIO_OTYPE_PP,GPIO_SPEED_100M,GPIO_PUPD_PU);
	//PF12,FSMC_A6
	//GPIO_Set(GPIOG,PIN12,GPIO_MODE_AF,GPIO_OTYPE_PP,GPIO_SPEED_100M,GPIO_PUPD_PU);
	//PG12,FSMC_NE4
 	...
 	GPIO_PinAFConfig(GPIOF,12,12);	//PF12,AF12
 	GPIO_PinAFConfig(GPIOG,12,12);	//PG12,AF12
